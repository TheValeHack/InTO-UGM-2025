...
export async function sendVerificationEmail(email, token) {
  ...
  await transporter.sendMail({
    ...
    to: email,
    subject: 'Verifikasi Email Anda - InTO UGM 2025',
    html: `
      <div style="font-family: Arial, sans-serif; color: #333;">
        <h1 style="text-align: center;">Selamat Datang di InTO UGM 2025!</h1>
        <p>Halo,</p>
        ...
        <div style="text-align: center; margin: 20px 0;">
          <a href="${verificationUrl}" 
            style="text-decoration: none; padding: 10px 20px; color: #fff; background-color: #B77749; border-radius: 5px; display: inline-block; font-weight: bold;">
            Verifikasi Email
          </a>
        </div>
    ...
    `,
    text: `
      Selamat Datang di InTO UGM 2025!
