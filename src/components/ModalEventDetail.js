    ...
    return (
        <Modal customClose={customClose} state={state} setState={setState} className={className} title={customTitle ? customTitle : 'MAIN EVENT'} noMinHeight={noMinHeight} >
            <div className="w-full flex flex-col items-center justify-center">
                <div className="w-fit text-center font-superbubble flex items-center justify-center text-xl min-[380px]:text-2xl md:text-4xl relative">
                ...
                <div className="w-fit text-center font-superbubble flex items-center justify-center text-xl min-[380px]:text-2xl md:text-4xl relative mt-[-10px]">
