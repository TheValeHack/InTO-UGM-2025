...
export default function ModalRegister({ className, state, setState, setLoginState }) {
  ...
  return (
    <>
      <Modal customClose={handleClose} showScrollbar={true} title={"REGISTER"} state={state} setState={setState} className={className}>
      <div className="flex flex-col sm:gap-3 w-full justify-center">
        <div className="w-full">
          <label className="text-[10px] sm:text-sm font-semibold text-[#B46632]">Nama</label>
          <BubbleInput
            type="text"
            name="name"
            value={formData.name}
        ...
        <div className="w-full mt-2 sm:mt-0">
          <label className="text-[10px] sm:text-sm font-semibold text-[#B46632]">Asal Sekolah</label>
          <BubbleInput
            type="text"
            name="school"
        ...
        <div className="w-full mt-2 sm:mt-0">
          <label className="text-[10px] sm:text-sm font-semibold text-[#B46632]">No. WhatsApp / No. Telepon</label>
          <BubbleInput
            type="text"
            name="phone"
        ...
        <div className="w-full mt-2 sm:mt-0">
          <label className="text-[10px] sm:text-sm font-semibold text-[#B46632]">Email Aktif</label>
          <BubbleInput
            type="text"
            name="email"
        ...
        <div className="w-full mt-2 sm:mt-0">
          <label className="text-[10px] sm:text-sm font-semibold text-[#B46632]">Password</label>
          <BubbleInput
            type="password"
            name="password"
        ...
        <div className="w-full mt-2 sm:mt-0">
          <label className="text-[10px] sm:text-sm font-semibold text-[#B46632]">Konfirmasi Password</label>
          <BubbleInput
            type="password"
        ...
        <div className="flex items-center gap-4 mt-3 sm:mt-0">
          <div className="cursor-pointer">
            ...
            />
            <Image
              src={isChecked ? "/images/checkbox_checked.png" : "/images/checkbox_unchecked.png"}
              width={100}
              height={100}
              alt="Checkbox"
              unoptimized
          ...
          <div className="text-[10px] sm:text-sm font-semibold text-[#B46632]">Remember me...</div>
        </div>
        <div className="text-[10px] sm:text-sm font-semibold text-[#B46632] mt-2 sm:mt-0">
          Kamu sudah punya akun yaa? Ayo{" "}
          <span
            className="text-[#FF9B8B] hover:text-[#f18574] cursor-pointer"
            onClick={() => {
              setIsLoading(false)
              setError(null)
              setFormData({
        ...
        <div className="w-full flex justify-between gap-4 mt-1 sm:mt-0">
          {
            isLoading ? (
                <BubbleButton
                  scale={1}
                  color="default"
                  className={"flex-1 text-lg sm:text-xl py-6"}
                >
