      ...
      <div className="max-w-[1950px] mx-auto flex flex-col w-screen relative">
          <section id="hero" className="px-6 md:px-12 lg:px-16 w-full min-h-screen flex flex-col-reverse md:flex-row justify-center md:justify-between items-center relative">
              ...
              <div className="w-full max-h-[300px] md:max-h-max translate-y-[15%] sm:translate-y-0 md:w-[40%] flex justify-end items-end z-10 translate-x-[25%] md:translate-x-0">
                <Image
                  ref={shipRef}
                  src={'/images/kapal_2.png'}
                  width={1000}
                  height={1000}
                  alt="kapal"
                  priority
                  className="w-full md:w-[70%] cursor-pointer max-w-[350px] md:max-w-max ship-animate"
                />
              </div>
          </section>
          ...
          <section id="about" className="w-full min-h-screen flex justify-center items-center relative">
              ...
              <div className="px-6 md:px-12 lg:px-16 w-full">
                <div data-aos="fade-up" data-aos-duration="1000" className="relative w-full md:w-[75%] lg:min-w-[650px] lg:w-[50%] max-w-[750px] z-30 mx-auto">
                  <BannerTitle text={'INTO UGM?'} className={'translate-y-[75%] mx-auto md:mx-0 md:translate-x-[15%] text-xl min-[380px]:text-[22px] w-[90%] md:w-fit md:text-4xl rotate-[-3deg] skew-x-3 drop-shadow-2xl px-6 py-4 md:px-12 md:py-8 z-20'} strokeClassName={'px-6 py-4 md:px-12 md:py-8'}/>
                  <Panel className={'text-base font-semibold text-[#5B3414]'}>
          ...
          <section id="event" className="w-full min-h-screen flex flex-col justify-start items-center relative">
              <div className="flex justify-center gap-10 relative w-full">
                  <div className="flex flex-col items-center justify-end z-20 mb-8 translate-x-[-5%]">
                    <BannerTitle text={'RANGKAIAN KEGIATAN'} className={'text-xl min-[380px]:text-[22px] md:text-5xl rotate-[-3deg] skew-x-3 drop-shadow-2xl px-8 py-6 md:px-16 md:py-8'} strokeClassName={'px-8 py-4 md:px-16 md:py-8'}/>
          ...
          <section id="testi" className="w-full min-h-[75vh] md:py-20 flex flex-col justify-start items-center relative">
            ...
            <div className="px-6 md:px-12 lg:px-16 py-24 w-full relative">
              <BannerTitle text={'APA KATA MEREKA?'} className={'mx-auto text-xl min-[380px]:text-[22px] w-full sm:w-[75%] md:w-fit md:text-5xl rotate-[-3deg] skew-x-3 drop-shadow-2xl px-6 py-6 md:px-14 md:py-10 z-20'} strokeClassName={'px-6 py-4 md:px-14 md:py-8'}/>
              <div className="mt-12 flex flex-col xl:flex-row justify-center items-center gap-9 lg:gap-5">
                {
                  testiData.map((testi, i) => {
                      return (
                        <div
                          key={i} 
                          className="flex-1 max-w-[270px] sm:max-w-[420px] lg:h-[720px]"
                          data-aos="fade-up" 
          ...
          <section id="partner" className="w-full min-h-[75vh] py-20 flex flex-col justify-start items-center relative">
            <div className="px-6 md:px-12 lg:px-16 w-full relative">
                <div data-aos="fade-up" data-aos-duration="1000" className="relative w-full md:w-[80%] lg:min-w-[650px] max-w-[750px] z-30 mx-auto">
                  <BannerTitle text={'IN PARTNERSHIP WITH'} className={'translate-y-[55%] md:translate-y-[40%] mr-auto ml-auto sm:mr-0 text-xl min-[380px]:text-[22px] w-fit md:text-3xl rotate-[-3deg] skew-x-3 drop-shadow-2xl px-6 py-6 md:px-16 md:py-8 z-20'} strokeClassName={'px-6 py-4 md:px-16 md:py-8'}/>
                  <div className="w-full p-3 pb-[45px] bg-[#E78B55] flex items-start justify-center rounded-[60px] shadow-[0px_5px_0px_#474135,inset_0px_-12px_0px_#B54E27] relative">
                    <div className="bg-[#F5DFB9] px-12 sm:px-4 xl:px-7 py-10 w-full h-full rounded-[48px] shadow-[0px_3px_10.3px_#474135,inset_0px_-13px_16.2px_#BC9D7F] relative">
                        ...
                        <div className="mx-auto max-w-[300px] sm:max-w-max flex flex-col sm:flex-row gap-4 items-center ">
                          <div className="w-full sm:w-[30%] p-4 xl:p-4 aspect-1 mx-auto shadow-[inset_0px_0px_23.5px_6px_rgba(255,255,255,0.25)] rounded-[48px] border-[5px] border-solid border-[#B77749] bg-[linear-gradient(180deg,#fbbb03_0%,#fb7f08_100%)] relative">
                          ...
                          <div className="flex-1 font-medium text-sm lg:text-base text-justify text-black">
